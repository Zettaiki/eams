 ...
 * @param <K3> the type of the third primary key of the table
 */
public interface TableTriplePk<V,K1,K2,K3> {
    /**
     ...
     */
    Optional<V> findByPrimaryKey(final K1 primaryKey1, final K2 primaryKey2, final K3 primaryKey3);
     ...
     */
    boolean delete(final K1 primaryKey1, final K2 primaryKey2, final K3 primaryKey3);
}
